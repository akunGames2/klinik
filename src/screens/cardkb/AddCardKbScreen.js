...
import { insert_cardkb } from '../../store/actions/cardkbAction'
class AddCardKbScreen extends BaseScreen {
  constructor(props) {
    super(props)
    this.state = {
      permission: {},            
...
AddCardKbScreen.navigationOptions = ({ navigation }) => ({
  title: 'TAMBAH DATA',
